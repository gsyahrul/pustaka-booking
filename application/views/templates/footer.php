...
<footer class="sticky-footer bg-white"> 
    <div class="container my-auto"> 
        <div class="copyright text-center my-auto"> 
            <span>Copyright &copy; Web Programming Univ. Nusa Mandiri 
with Bootstrap SB Admin 2 <?= date('Y'); ?></span> 
        </div> 
    </div> 
</footer> 
<!-- End of Footer --> 
...
dismiss="modal" aria-label="Close"> 
            ...
            <div class="modal-body">Pilih "Logout" di bawah jika kamu 
yakin sudah selesai.</div> 
