                  ...
                  <div class="navbar-nav">
                      ...
                      <?php
                        if (!empty($this->session->userdata('email'))) { ?>
                          <a class="nav-item nav-link" href="<?= base_url('booking'); ?>">Booking <b> <?= $this->ModelBooking->getDataWhere('temp', ['email_user' => $this->session->userdata('email')])->num_rows(); ?> Buku</a>
                          <a class="nav-item nav-link" href="<?= base_url('member/myprofile'); ?>">Profil Saya</a>
                          <a class="nav-item nav-link" href="<?= base_url('member/logout'); ?>"><i class="fas fw fa-login"></i>Log out</a><?php
                        } else { ?>
                      ...
                      <?php } ?>
                      <span class="nav-item nav-link nav-right" style="display:block; margin-left:10px;">Selamat Datang <b><?= $user; ?></b></span>
                  </div>
              </div>
          </div>
      </nav>
